...
import com.google.droidar.gl.scenegraph.MultiColoredShape;
import com.google.droidar.gl.scenegraph.Shape;
import com.google.droidar.gl.textures.Textured2dShape;
import com.google.droidar.gl.textures.TexturedShape;
...
public class GLFactory {
	...
	public Obj newTextObject(String textToDisplay, Vec textPosition,
		...
		MeshComponent mesh = this.newTexturedSquare("textBitmap"
				+ textToDisplay, com.google.droidar.util.IO.loadBitmapFromView(v), textSize);
